...
project_name="stem"
experiment_name="olmo2-1b-stem-4T-midfine100B-code-stem"
NNODES=4
...
torchrun --nproc-per-node=8 --nnodes=${NNODES} -m apps.main.stem_train \
    config=apps/main/configs/stem_olmo2_1B_midtrain_stem.yaml \
    dump_dir=/data-fsx/beidchen-sandbox/data/logs/${experiment_name} \
    checkpoint.init_ckpt_path=/data-fsx/beidchen-sandbox/data/logs/olmo2-1b-stem-4T-midfine100B-code/checkpoints/0000025000 \
