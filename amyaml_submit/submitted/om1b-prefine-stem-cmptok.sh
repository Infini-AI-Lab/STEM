...
project_name="stem"
experiment_name="olmo2-1b-stem-comptok-warmup100B-1_1"
NNODES=4
...
torchrun --nproc-per-node=8 --nnodes=${NNODES} -m apps.main.stem_compressed_train \
    config=apps/main/configs/stem_olmo2_1B_compressed_prefine.yaml \
