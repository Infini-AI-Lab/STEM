...
The following commands creates the environment for STEM.
...
This command will download the `fineweb_edu` and prepare it for training in the `./data` directory. See [here](https://github.com/facebookresearch/lingua) for more details.
```bash
