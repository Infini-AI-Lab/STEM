...
def main(dataset, memory, data_dir, seed=42, nchunks=32):
    ...
    repo_id = {
        ...
        "dclm_baseline_1.0_5prct": "mlfoundations/dclm-baseline-1.0",
    ...
    orig_extension = {
        ...
        "dclm_baseline_1.0_5prct": ".jsonl.zst",
    ...
    cat_command = {
        ...
        "dclm_baseline_1.0_5prct": "zstdcat {} && echo",
        "dclm_baseline_1.0_1prct": "zstdcat {} && echo",
    ...
    allow_patterns = {
        ...
        "dclm_baseline_1.0_5prct": "global-shard_01_of_10/local-shard_[0-4]_of_10/*.jsonl.zst",
