...
# =============================================================================
# Qwen3 Attention: identical to Llama3 Attention but with QK-Norm
# (RMSNorm applied per-head to Q and K projections before RoPE)
# =============================================================================
class Qwen3Attention(nn.Module):
    ...
    def forward(
        ...
        # Qwen3-specific: apply per-head RMSNorm to Q and K before RoPE
        xq = self.q_norm(xq)
        xk = self.k_norm(xk)
...
# =============================================================================
# Qwen3 Transformer Block: uses Qwen3Attention instead of Attention
# =============================================================================
...
# =============================================================================
# Qwen3 Base Transformer: uses Qwen3TransformerBlock instead of TransformerBlock
# =============================================================================
class Qwen3BaseTransformer(nn.Module):
    def __init__(self, args: BaseTransformerArgs):
        super().__init__()
        self.dim = args.dim
...
# =============================================================================
# Qwen3 LM Transformer: full language model (mirrors apps/main/transformer.py)
# =============================================================================
@dataclass
class Qwen3LMTransformerArgs(BaseTransformerArgs):
...
class Qwen3LMTransformer(Qwen3BaseTransformer):
    def __init__(self, args: Qwen3LMTransformerArgs):
        super().__init__(args)
...
def build_fsdp_grouping_plan(model_args: Qwen3LMTransformerArgs):
...
def tp_parallelize(model, tp_mesh, model_args: Qwen3LMTransformerArgs, distributed_args):
